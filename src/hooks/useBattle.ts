...
export const useBattle = (playerName: string) => {
  ...
  const [gameType, setGameType] = useState<"quiz" | "royal" | "dungeon" | "dobon" | "majority" | "quick" | "dice" | "onigokko" | "space" | "word" | "mind" | "usohonto" | "friend" | "koredochi" | "synchro" | "timetalk">("quiz");
  ...
  useEffect(() => {
    ...
    const handleRoomPlayersUpdate = ({
      ...
      gameType: "quiz" | "royal" | "dungeon" | "dobon" | "majority" | "quick" | "dice" | "onigokko" | "space" | "word" | "mind" | "usohonto" | "friend" | "koredochi" | "synchro" | "timetalk";
      ...
      if (gameType === "dungeon" || gameType === "royal" || gameType === "dobon" || gameType === "majority" || gameType === "quick" || gameType === "dice" || gameType === "onigokko" || gameType === "space" || gameType === "word" || gameType === "mind" || gameType === "usohonto" || gameType === "friend" || gameType === "koredochi" || gameType === "synchro" || gameType === "timetalk") {
  ...
  /* =========================
     参加処理
  ========================= */
  const joinRandom = (options?: { maxPlayers?: number; gameType?: "quiz" | "royal" | "dungeon" | "dobon" | "majority" | "quick" | "dice" | "onigokko" | "space" | "word" | "mind" | "usohonto" | "friend" | "koredochi" | "synchro" | "timetalk"; userId?: string | null; }, onJoined?: (code: string) => void) => {
    if (!socket) return;
  ...
  const joinWithCode = (code: string, count: string, type: "quiz" | "royal" | "dungeon" | "dobon" | "majority" | "quick" | "dice" | "onigokko" | "space" | "word" | "mind" | "usohonto" | "friend" | "koredochi" | "synchro" | "timetalk", userId?: string | null) => {
    if (!socket) {
