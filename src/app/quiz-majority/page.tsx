...
export default function QuizMasterPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 text-center bg-gradient-to-r from-red-500 to-blue-500">
      <h1
      ...
      >
        ...
        <span className="hidden md:block">多数決クイズ</span>
      </h1>
      ...
      <>
        ...
        >
          ...
          >
            「多数決クイズ」は、チームで力を合わせて答えを決める協力型クイズゲームです。<br />
            各問題は2択。プレイヤーはそれぞれ A か B を選んで回答します。もっとも多く選ばれた答えが、チームの最終回答になります。<br />
            まだ回答していないプレイヤーがいる場合、その人の答えはランダムに決まります。<br />
            また、チーム内で A と B が同数になった場合も、チームの答えはランダムで選ばれます。<br />
            チームの答えが正解ならステージクリア！全部で10ステージ用意されており、すべて正解できればゲームクリアとなります。<br />
            仲間を信じるか、それとも運に任せるか――全ステージクリアを目指して挑戦してみましょう！<br />
            ※オンラインでチーム仲間が見つからない場合は、CPU（コンピュータ）との挑戦になります。
          </p>
        </div>
      </>
    </div>
