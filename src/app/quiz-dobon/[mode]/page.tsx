...
const BONUS_TABLE: Record<number, number[]> = {
  ...
  4: [500, 250, 120],
  5: [700, 350, 170, 80],
  6: [900, 450, 220, 110, 50],
  7: [1200, 600, 300, 150, 70, 30],
  8: [1500, 750, 360, 180, 90, 40, 20],
};
...
export default function QuizModePage() {
  ...
  useEffect(() => {
    ...
    if (mode === "random") {
      joinRandom({ maxPlayers: 4, gameType: "dobon" }, (code) =>
        setRoomCode(code)
      );
    } else {
  ...
  return (
    <>
    <OnlineGameNotice />
    <div className="container mx-auto p-1 md:p-8 text-center bg-gradient-to-b from-stone-400 via-amber-100 to-stone-400" key={battleKey}>
      {countdown !== null && (
