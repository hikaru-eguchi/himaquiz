...
export default function TimeAttackRankingTop10({ rows }: { rows: Row[] }) {
    ...
    <>
      <div className="mt-6">
        <div className="mx-auto w-full max-w-[760px]">
          <div className="rounded-[28px] border border-sky-200 bg-[#f8fbff] p-4 md:p-6 shadow-[0_12px_30px_rgba(0,0,0,0.08)]">
            <div className="text-center">
              <p className="text-sm md:text-base font-black text-sky-500 drop-shadow-sm">
                みんなのタイムアタック⚡
              </p>
