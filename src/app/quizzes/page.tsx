...
export default async function QuizzesPage({ searchParams }: PageProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <p className="text-center text-xl md:text-2xl font-extrabold text-gray-800 leading-relaxed -mt-2 mb-3"> ひまな時間にぴったり！「ひまQ」は簡単に遊べる脳トレクイズや暇つぶしクイズが満載です。クイズで頭の体操をしよう！ </p>
      {/* ★ クイズ数表示（中央） */}
      <p
