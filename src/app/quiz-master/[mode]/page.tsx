...
const enemies = [
  ...
  { id: "kinghydra", name: "キングヒドラ", image: "/images/キングヒドラ_1.png", hp: 4000, attack: 4000, description: "複数の首を持つ巨大魔獣。倒しても再生する恐怖の存在。" },
  { id: "ordin", name: "オーディン", image: "/images/オーディン_1.png", hp: 5000, attack: 5000, description: "知恵と戦の神。魔法と剣技を極めた伝説の戦士。" },
  { id: "poseidon", name: "ポセイドン", image: "/images/ポセイドン_1.png", hp: 6000, attack: 6000, description: "海の神。雷と津波で敵を蹴散らす力を持つ。" },
  { id: "hades", name: "ハデス", image: "/images/ハデス_1.png", hp: 8000, attack: 8000, description: "冥界の支配者。死者の力を操り、強大な攻撃を仕掛ける。" },
