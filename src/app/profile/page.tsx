...
const sections = [
  ...
  return (
    <div className="bg-white shadow-lg rounded-xl p-8 sm:p-12">
      <h1 className="text-3xl sm:text-5xl text-gray-900 mb-8 text-center">サイト紹介</h1>
      ...
      <div className="prose prose-lg max-w-3xl mx-auto text-gray-600">
        <h2 id="name" className="text-3xl text-gray-800 mt-5 mb-4">運営者プロフィール</h2>
        <Image
          src="/images/man.png"
          alt="男性の写真"
          width={160}       // 横幅
        ...
        <h2 id="sitename" className="text-3xl text-gray-800 mt-5 mb-4">サイト名</h2>
        <p>
          サイト名は「ひまQ」（
          <a 
        ...
        <h2 id="otoiawase" className="text-3xl text-gray-800 mt-5 mb-4">お問い合わせ</h2>
        <p>
        ...
        <h2 id="okukoku" className="text-3xl text-gray-800 mt-5 mb-4">広告について</h2>
        <p>
          「当サイトでは、一部のクイズにてアフィリエイト広告（成果報酬型広告）を利用しています。購入等に関しては、リンク先の公式サイトの情報をご確認の上、ご判断をお願いいたします。
        </p>
        <h2 id="menseki" className="text-3xl text-gray-800 mt-5 mb-4">免責事項</h2>
        <p>
          掲載内容には十分注意を払っていますが、情報の正確性・安全性を保証するものではありません。商品の購入やサービスの利用などはご自身の責任でお願いいたします。
        </p>
        <h2 id="privacy" className="text-3xl text-gray-800 mt-5 mb-4">プライバシーポリシー</h2>
        <p>
