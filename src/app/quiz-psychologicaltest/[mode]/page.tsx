...
export default function QuizModePage() {
  ...
  if (!selectedDiagnosis) {
    return (
      <div className="relative overflow-hidden min-h-screen bg-gradient-to-b from-pink-300 via-rose-200 to-fuchsia-200">
  ...
  return (
    <div className="min-h-screen container mx-auto p-8 text-center bg-gradient-to-b from-pink-300 via-rose-200 to-fuchsia-200">
      {!finished ? (
        <>
