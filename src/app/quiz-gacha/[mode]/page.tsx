...
export default function QuizModePage() {
  ...
  const gachaCharacters = [
    { name: "スライム", image: "/images/slime.png", rarity: "ノーマル", weight: 30 },
    { name: "ゴブリン", image: "/images/goblin.png", rarity: "ノーマル", weight: 25 },
    { name: "ミミック", image: "/images/mimic.png", rarity: "ノーマル", weight: 15 },
    { name: "バーサーカー", image: "/images/berserker.png", rarity: "ノーマル", weight: 10 },
    { name: "フェニックス", image: "/images/fenikkusu.png", rarity: "レア", weight: 8 },
    { name: "ドラゴン", image: "/images/dragon.png", rarity: "レア", weight: 5 },
    { name: "ブラックドラゴン", image: "/images/blackdragon.png", rarity: "超レア", weight: 3 },
    { name: "リヴァイアサン", image: "/images/leviathan.png", rarity: "超レア", weight: 2 },
    { name: "ポセイドン", image: "/images/poseidon.png", rarity: "超レア", weight: 1.5 },
    { name: "軍荼利明王（ぐんだりみょうおう）", image: "/images/gundarimyouou.png", rarity: "超レア", weight: 1 },
    { name: "ハデス", image: "/images/hades.png", rarity: "激レア", weight: 0.5 },
    { name: "ゼウス", image: "/images/zeus.png", rarity: "激レア", weight: 0.3 },
    { name: "オーディン", image: "/images/ordin.png", rarity: "激レア", weight: 0.2 },
    { name: "初代クイズマスターの最強勇者", image: "/images/yuusya_game.png", rarity: "超激レア", weight: 0.1 },
