...
export default function QuizMasterPage() {
  ...
  const handleRandomQuizStart = () => {
    router.push(`/quiz-dice/random?time=${limitTime}`);
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8 text-center bg-gradient-to-b from-green-700 via-emerald-500 to-amber-300">
      ...
      >
        ...
        <span className="hidden md:block">サイコロクイズ</span>
      </h1>
      ...
      <>
          ...
          <div className="mt-6 bg-white p-4 rounded-xl max-w-md mx-auto border-2 border-black">
            ...
            <button
              onClick={() => {
                ...
                router.push(
                  `/quiz-dice/code?time=${limitTime}&code=${battleCode}&count=${playerCount}`
                );
              }}
        ...
        >
          ...
          >
            「サイコロクイズ」は、正解するたびにサイコロが転がるドキドキクイズゲーム！<br />
            クイズは全5問！正解するとサイコロを振って、出た目 × 100点をゲット！<br />
            1でピンチ！？6なら超ラッキー！？運しだいで大逆転もあり！<br />
            ラストには3択アイテムチャンスも登場！最後まで順位はわからない！<br />
            知識・ひらめき・運を味方につけて、トップを目指そう！<br />
