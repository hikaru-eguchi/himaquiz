  ...
  return (
    <div className="container mx-auto px-4 py-8 text-center bg-yellow-50">
      ...
      <p className="text-md md:text-2xl font-semibold text-gray-800 mb-8">
        きまぐれにいろんなひまもんが出現！クイズに正解してともだちになろう！
      </p>
      ...
      >
        ...
        >
          「きまぐれクイズ」は、クイズを解きながらいろんなひまもんに出会うほのぼのクイズゲームです。<br />
          出会えるひまもんは全部で80種類！どんなひまもんに出会えるかはお楽しみ！✨<br />
          クイズに正解するとひまもんとともだちになり、図鑑に登録されます（※ログインが必要です）。<br />
        </p>
      </div>
    </div>
  );
